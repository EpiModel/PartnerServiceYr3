...
scenarios_df <- tibble(
  ...
  .at                 = 1,
  prep.start.prob_1   = seq(0.6250, 0.6375, length.out = n_scenarios), # 206
  prep.start.prob_2   = seq(0.7625, 0.7875, length.out = n_scenarios), # 237
  prep.start.prob_3   = seq(0.7625, 0.7750, length.out = n_scenarios), # 332
  prep.discont.rate.cPC_1 = rep(0.00688, n_scenarios),
  prep.discont.rate.cPC_2 = prep.discont.rate.cPC_1,
  prep.discont.rate.cPC_3 = prep.discont.rate.cPC_1
)
