...
outcomes_sims_tbl2 <- get_outcome_sims_tbl2(full_intervdata_tbl2) %>% 
  select(tbl, scenario.num, scenario.new, scenario_name,sim,
         ...
         elig.partners.gen2, found.partners.gen2, prp.partners.found.gen2, negunkPart.indexes.gen2, posPart.indexes.gen2, 
         elig.partners.all, found.partners.all, prp.partners.found.all, negunkPart.indexes.all, posPart.indexes.all,
