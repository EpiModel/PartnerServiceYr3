...
param <- param_msm(
  ...
  part.ident.start       = 1,                                                   #turn on partner identification to start at timestep=1 (default=Inf i.e. no partner identification)
  ...
  #PPic.hiv.test.rate    = c(0.0211,0.0293,0.0224)
  #PPnic.hiv.test.rate   = c(0.0104,0.0271,0.0170)
)
init <- init_msm()
