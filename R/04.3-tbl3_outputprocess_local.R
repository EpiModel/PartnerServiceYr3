##
## Processing counterfactual scenarios
##
...
#get batch info
batches_infos <- EpiModelHPC::get_scenarios_batches_infos(sims_dir)
...
saveRDS(full_intervdata_tbl3, paste0(save_dir, "/tbl3_fulldata.rds", sep=""))
